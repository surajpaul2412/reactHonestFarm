        ...
        <div className="xs-center d-none d-md-block">
          <div className="row">
            <div className="col-lg-4 col-md-6 usps" align="center">
              <picture>
                <source
                  srcSet="/static/assets/img/Frame-6.webp"
                  type="image/webp"
                />
                <img
                  className="d-block mx-auto w-40"
                  src="/static/assets/img/Frame-6.png"
            ...
            <div className="col-lg-4 col-md-6 usps" align="center">
              <picture>
                <source
                  srcSet="/static/assets/img/Frame-7.webp"
                  type="image/webp"
                />
                <img
                  className="d-block mx-auto w-40"
                  src="/static/assets/img/Frame-7.png"
                  alt="honest-farm-usps"
                />
              </picture>
              <h2 className="text-success pt-4">
            ...
            <div className="col-lg-4 col-md-6 usps" align="center">
              <picture>
                <source
                  srcSet="/static/assets/img/Frame-8.webp"
                  type="image/webp"
                />
                <img
                  className="d-block mx-auto w-40"
                  src="/static/assets/img/Frame-8.png"
                  alt="honest-farm-usps"
                />
              </picture>
              <h2 className="text-success pt-4">
