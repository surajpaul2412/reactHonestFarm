                  ...
                  <ul className="navbar-nav ml-auto">
                    <li className="nav-item dropdown">
                      ...
                      <div className="dropdown-menu" aria-labelledby="navbar2">
                        <Link href="/#about">
                          <a className="dropdown-item">Honest Farms</a>
                        </Link>
                    ...
                    <li className="nav-item ">
                      <Link href="/#usp">
                        <a className="nav-link js-scroll-trigger">Our USPs</a>
                      </Link>
                    </li>
                    <li className="nav-item dropdown">
                      <Link href="/#product">
                      ...
                      <div className="dropdown-menu" aria-labelledby="navbar3">
                        <Link href="/#product">
                          <a className="dropdown-item">Rice</a>
                        </Link>
                        <Link href="/#product">
                          <a className="dropdown-item">Pulses</a>
                        </Link>
                        <Link href="/#product">
                          <a className="dropdown-item">Peanuts</a>
                        </Link>
                      </div>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <Link href="/#certificate">
                        <a className="nav-link" style={{ marginTop: "-8px" }}>
                          <button className="btn btn-main py-2 media-center">
                            <span className="media-d-none">Get Your </span>{" "}
                            Pesticide Free Certificate
                          </button>
                        </a>
                      </Link>
                    </li>
